...
export const UI_COPY = {
  en: {
    ...
    teachingSourceDetail: "Review the recorded actions",
    agentStructured: "Create conditions",
    agentStructuredDetail: "Create 7 reusable conditions",
    humanConstrained: "Confirm boundary",
    humanConstrainedDetail: "A person reviews the conditions before publishing",
    websiteEnforced: "Reuse safely",
    websiteEnforcedDetail: "Each reservation is checked against the published conditions",
    ...
    nightTeachingHeadline: "Create a late-night arrival rule",
    nightTeachingBody:
      "Use the recorded dietary and taxi handling to define when this response can be reused.",
    ...
    nightHumanConstrainedDetail:
      "Review the 7 extracted conditions before publishing",
    ...
    agentDraftHeading: "Create proposed conditions",
    agentDraftBody:
    ...
    createAgentDraftNote:
      "Detected: arrival by 23:00 · taxi request handled",
    ...
    nightPublishBlocked: "Escalate compensation requests to publish.",
    ...
    webMcpCheckingDetail: "Checking whether approved changes can be applied.",
    webMcpReadyDetail: "The exact approved change can be applied.",
    webMcpUnavailableDetail:
      "Preview and human review still work in this browser.",
    webMcpErrorDetail: "Reload this page in a supported browser before applying.",
    ...
    webMcpEvidence: "WebMCP evidence",
  ...
  ja: {
    ...
    teachingSourceDetail: "記録された対応を確認",
    agentStructured: "条件を作成",
    agentStructuredDetail: "7つの再利用条件を作成",
    humanConstrained: "境界を確認",
    humanConstrainedDetail: "担当者が条件を確認して公開",
    websiteEnforced: "条件内で再利用",
    websiteEnforcedDetail: "予約ごとに公開済みの条件を判定",
    ...
    nightTeachingHeadline: "深夜到着の対応ルールを作る",
    nightTeachingBody:
      "食事制限やタクシー手配を含む対応をもとに、再利用できる条件を確認して公開します。",
    ...
    agentDraftHeading: "再利用条件の草案を作る",
    agentDraftBody:
      "記録した対応から再利用条件の草案を作ります。公開前に担当者の確認が必要です。",
    createAgentDraft: "草案を作成",
    createAgentDraftNote: "検出条件：23:00までの到着 · タクシー依頼に対応",
    ...
    nightPublishBlocked: "補償依頼を担当者対応にすると公開できます。",
    publishReady: "人が決めた境界を公開できます。",
    journeyProof: "この対応ルールができるまで",
    journeyProofSummary:
      "実例を記録 · 条件を提案 · 担当者が確認 · 条件内で再利用",
    cases: "予約一覧",
    caseSearch: "予約を検索",
    ...
    webMcpCheckingDetail: "承認後の変更を反映できるか確認しています。",
    webMcpReadyDetail: "承認した内容だけを反映できます。",
    webMcpUnavailableDetail:
      "この画面での変更案作成と担当者確認は利用できます。",
    webMcpErrorDetail:
      "変更を反映する前に、対応ブラウザでページを再読み込みしてください。",
