...
export const UI_COPY = {
  en: {
    ...
    included: "Included",
    none: "None",
    readyHeading: "Ready for agent preparation",
    readyBody:
      "Late Arrival Care can prepare a bounded preview for this selected case. Nothing changes until a person approves it.",
    prepareLocally: "Prepare preview locally",
    ...
    approvedReady: "Approved — ready to commit",
    committed: "Committed",
  ...
  ja: {
    ...
    included: "あり",
    none: "なし",
    readyHeading: "プレビューを作成できます",
    readyBody:
      "「レイトアライバル対応」は、選択中の予約だけを対象に変更案を作成します。担当者が承認するまで、予約は変更されません。",
    prepareLocally: "この画面で変更案を作る",
    proposedChanges: "変更案",
    ...
    preparePreview: "変更案を作る",
    approvePreview: "この内容を承認",
    approvedReady: "承認済み — 実行待ち",
    committed: "反映済み",
    prepareAgain: "もう一度準備",
    discard: "破棄",
    viewAudit: "操作履歴を見る",
